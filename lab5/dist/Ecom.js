...
class ShoppingCart {
    ...
    checkout() {
        ...
        const order = new Order(`ORD-${Date.now()}`, this.customer.id, [...this.items]);
        this.clear();
        return order;
    }
    toString() {
...
function runShop() {
    const laptop = new Product("p1", "Laptop", 1200, "High-performance laptop", 10);
    const smartphone = new Product("p2", "Smartphone", 800, "Latest smartphone model", 20);
    const customer = new Customer("c1", "John Doe", "john@example.com", "123 Main St");
